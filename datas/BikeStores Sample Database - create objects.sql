-- create schemas (MySQL uses databases instead of schemas in this context)
-- A database can be used to represent a schema.
-- Alternatively, you can use a schema, but it's often more practical to create a new database.
